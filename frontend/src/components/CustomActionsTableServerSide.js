                  ...
                  {columnsTable.map((col, index) => (
                    <Box
                      ...
                      sx={{
                        ...
                        pr: index === 0 && rowActions?.length ? 8 : 0,
                      }}
                    >
                      <Typography
                        variant="caption"
...
// --------------------------------------------------
// --------------------------------------------------
//            CustomActionsTableServer
// --------------------------------------------------
// --------------------------------------------------

const CustomActionsTableServer = ({
  ...
  rowActions = [], // Array de componentes de acciones para material react table, mostradas en cada row de la tabala
}) => {
...
export default CustomActionsTableServer
