...
def createContraCliDF():
    ...
    with engine.connect() as connection:
        with connection.begin():
            ...
            check_exist = connection.execute(text("SELECT concodcontrato FROM cxcccontratos WHERE ciacodigo = :cia AND concodcontrato = :con"), {"cia": sCodCia, "con": concodcontrato}).fetchone()
            if check_exist:
