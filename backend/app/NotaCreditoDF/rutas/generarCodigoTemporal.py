...
def generarCodigoTemporal(cjacodigo):
    """Genera el código NEMOTÉCNICO de la NC según la caja seleccionada"""
    claims = get_jwt()
    ...
    with engine.connect() as connection:
        ...
        if not serie:
            raise ValidationError("No existe configuración SRI (04) para la caja seleccionada.")
        ...
        nccodigo = f"C{year}{sriserie01}{sriserie02}{secuencia_actual:09}"

    return {"data": nccodigo}
