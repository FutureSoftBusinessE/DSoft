      ...
      <div className="main main-docs">
        <Container>
          ...
          <p className="main-title-text">
            Use background utilities to quickly style the background of an element. Great for cards, buttons, or any
            other element.
          </p>
...
<div className="flex-fill ht-100 bg-dark bg-gradient"></div>`}</code>
          ...
          <p>
            Background-color utilities are generated with Sass using CSS variables. This allows for real-time color
