      ...
      <div className="main main-docs">
        <Container>
          ...
          <p className="main-title-text">
            Give textual form controls like inputs and textareas an upgrade with custom styles, sizing, focus states,
            and more.
          </p>
...
<Form.Control type="text" value="Disabled readonly input" disabled readOnly />`}</code>
          ...
          <p>
            The file input is the most gnarly of the bunch and requires additional JavaScript if you'd like to hook them
            up with functional Choose file… and selected file name text.
          </p>
