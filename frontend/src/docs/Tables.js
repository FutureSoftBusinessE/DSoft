    ...
    <React.Fragment>
      ...
      <div className="main main-docs">
        <Container>
          ...
          <p>
            Using the most basic table markup, here’s how .table based tables look in Bootstrap. All table styles are
            inherited in Bootstrap 5, meaning any nested tables will be styled in the same manner as the parent.
          </p>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>$250,000</td>
          ...
          <p>
            Use <code>striped</code> props to add zebra-striping to any table row within the tbody.
          </p>
          ...
          <p>
            Add <code>hover</code> props to enable a hover state on table rows within a tbody.
          </p>
...
<Table variant="success">...</Table>`}</code>
          ...
          <p>
            Add <code>bordered</code> props for borders on all sides of the table and cells. Add <code>borderless</code>{" "}
          ...
          <p>
            Add <code>size</code> props to make any table more compact by cutting all cell padding in half.
          </p>
          ...
          <p>
            ...
            viewports by wrapping a table with props <code>responsive</code>.
          </p>
          ...
          <p className="main-title-text">
            Grid.js is a table plugin written in TypeScript. It is developed to be used with all popular JavaScript
            frameworks include React, Angular.js, Vue or without any frameworks!{" "}
          </p>
...
/>`}</code>
          ...
          <p>
            Supports global search on all rows and columns. Set <code>search: true</code> to enable the search plugin.
          </p>
...
/>`}</code>
          ...
          <p>
            Simply add <code>resizable: true</code> to your config to enable resizable columns.
          </p>
