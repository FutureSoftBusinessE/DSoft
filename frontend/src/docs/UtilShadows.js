      ...
      <div className="main main-docs">
        <Container>
          ...
          <p>
            ...
            <code>$enable-shadows</code>, you can also quickly add or remove a shadow with our box-shadow utility
            classes. Includes support for <code>.shadow-none</code> and three default sizes (which have associated
            variables to match).
          </p>
