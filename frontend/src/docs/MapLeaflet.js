      ...
      <div className="main main-docs">
        <Container>
          ...
          <p className="main-title-text">
            Leaflet is designed with simplicity, performance and usability in mind. It works efficiently across all
    ...
    <Marker position={[51.505, -0.09]} icon={icon}>
      <Popup>
        A pretty CSS3 popup. <br /> Easily customizable.
          ...
          <p>
            Besides tile layers, you can easily add other things to your map, including polylines, polygons, circles,
            and popups.
          </p>
