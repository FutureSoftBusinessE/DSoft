      ...
      <div className="main main-docs">
        <Container>
          ...
          <p className="main-title-text">
            Customize the native selects with custom CSS that changes the element’s initial appearance.
          </p>
          ...
          <p>
            Custom styles are limited to the select's initial appearance and cannot modify the options due to browser
            limitations.
          </p>
...
<Form.Select size="sm">
  ...
  <option>Disabled select</option>
          ...
          <p>
            By default it does have a search box displayed but most of the time this template uses select without a
            search.
          </p>
          ...
          <p>
            React Select will respond to the disabled attribute on select elements. You can also initialize it with{" "}
          ...
          <p>
            React Select also supports multi-value select boxes. The select below is declared with the multiple
            attribute.
          </p>
          ...
          <p>
            When <code>isClearable</code> set to true, causes a clear button close icon to appear on the select box when
            a value is selected. Clicking the clear button will clear the selected value, effectively resetting the
            select box back to its placeholder value.
          </p>
