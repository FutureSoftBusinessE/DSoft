    ...
    <React.Fragment>
      ...
      <div className="main main-docs">
        <Container>
          ...
          <p>
            Images in React Bootstrap are made responsive using fluid set to true with max-width: 100%; and height:
            auto; are applied to the image so that it scales with the parent element.
          </p>
          ...
          <p>
            In addition to our border-radius utilities, you can use thumbnail props to give an image a rounded 1px
            border appearance.
          </p>
                ...
                <Col sm="9" md="7">
                  <figure className="figure-overlay">
                    ...
                    <figcaption className="p-4 text-white">
                      ...
                      <p className="mb-0">
                        Royalty free means you just need to pay for rights to use the item once per end product. You
                        don't need to pay additional or ongoing fees for each person who sees or uses it.
                      </p>
                    </figcaption>
                  </figure>
                </Col>
