...
<Button variant="dark">Dark</Button>`}</code>
          ...
          <p>
            In need of a button, but not the hefty background colors they bring? Replace the variant attribute with the{" "}
...
<Button variant="primary" size="lg">Large button</Button>`}</code>
  ...
  <Button variant="secondary">Large button</Button>
          ...
          <p>
            Buttons will appear pressed (with a darker background, darker border, and inset shadow) when active and also
...
<Button variant="primary" disabled>Disabled Button</Button>`}</code>
          ...
          <p>
            Make rounded corner buttons by adding a class modifier from Bootstrap utilities class{" "}
...
<Button variant="success" className="rounded-pill">Success Button</Button>`}</code>
          ...
          <p>
            Make icon buttons by adding only icon and add class modifier using <code>.btn-icon</code>
          </p>
