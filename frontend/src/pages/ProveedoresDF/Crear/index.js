...
const CrearProveedorDF = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.procalif === "R" && formData.proruc.length !== 13)
      return showWarning("El R.U.C. debe tener 13 dígitos")
    if (formData.procalif === "C" && formData.proruc.length !== 10)
      return showWarning("La Cédula debe tener 10 dígitos")
    if (!formData.pronombre.trim() || !formData.prodirec.trim())
      return showWarning("Nombre y Dirección son obligatorios")
    ...
    <ThemeProvider theme={theme}>
      ...
      <div className="main main-app p-3 p-lg-4">
        ...
        <div style={{ display: "flex", justifyContent: "center", mb: "30px", fontSize: "25px" }}>
          <b>Nuevo Proveedor (Código Automático)</b>
        </div>
            ...
            <Grid container spacing={3}>
              <Grid item xs={12} sm={4}>
                <TextField
                  ...
                  onChange={(e) => setFormData({ ...formData, procalif: e.target.value, proruc: "" })}
                >
              ...
              <Grid item xs={12} sm={8}>
                <TextField
                  ...
                  inputProps={{ maxLength: formData.procalif === "R" ? 13 : 10 }}
                />
              </Grid>
