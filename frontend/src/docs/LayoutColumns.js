...
export default function LayoutColumns() {
      ...
      <div className="main main-docs">
        <Container>
          ...
          <p className="main-title-text">
            Learn how to modify columns with a handful of options for alignment, ordering, and offsetting thanks to our
            flexbox grid system.
          </p>
  ...
  <Col xs="3"><span>2 of 2 Column</span></Col>
          ...
          <p>
            Breaking columns to a new line in flexbox requires a small hack: add an element with width: 100% wherever
            you want to wrap your columns to a new line.
          </p>
  ...
  <Col xs="4"><span>4 of 4 Column</span></Col>
          ...
          <p>
            ...
            can set the order by breakpoint.
          </p>
  ...
  <Col xs="4" className="order-1"><span>3 of 3 Column</span></Col>
          ...
          <p>
            You can offset grid columns in two ways: our responsive .offset- grid classes and our margin utilities. Grid
            classes are sized to match columns while margins are more useful for quick layouts where the width of the
            offset is variable.
          </p>
  ...
  <Col xs="4" className="offset-3"><span>2 of 2 Column</span></Col>
          ...
          <p>
            With the move to flexbox in v4, you can use margin utilities like .me-auto to force sibling columns away
            from one another.
          </p>
