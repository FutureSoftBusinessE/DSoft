...
export default function NavTabs() {
    ...
    <React.Fragment>
      ...
      <div className="main main-docs">
        <Container>
          ...
          <p>
            Navigation available in Bootstrap share general markup and styles, from the base .nav class to the active
  ...
  <Nav.Item>
    <Nav.Link disabled>Disabled</Nav.Link>
          ...
          <p>
            Take that same HTML, but add variant <code>pills</code> props to it. Same goes to vertical nav.
          </p>
          ...
          <p>
            You can mix and match the Dropdown components with the NavLink and NavItem components to create a Dropdown
            that plays well in a Nav component.
          </p>
  ...
  <NavDropdown title="Dropdown" id="nav-dropdown">
    ...
    <NavDropdown.Item eventKey="4.4">Separated link</NavDropdown.Item>
          ...
          <p>
            Responsive navigation header, the navbar. Includes support for branding, navigation, and more, including
