...
const CrearPuntosEmisionSri = () => {
  ...
  const [detalles, setDetalles] = useState([
    ...
    {
      srisecdoc: "03",
      desc: "Liquidación de compra de Bienes o Prestación de servicio",
      srisecini: 1,
      srisecfin: "",
      srisecact: 0,
    },
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.cjacodigo || formData.cjacodigo.length > 3)
      return showWarning("Código de caja requerido (máx. 3 caracteres).")
    ...
    if (formData.sripreauto !== "E") {
      ...
      if (faltanSecuencias)
        return showWarning("Debe ingresar la secuencia final mayor a cero para todos los documentos.")
    }
              ...
              <Grid container spacing={3}>
                <Grid item xs={12}>
                  <Autocomplete
                    ...
                    renderInput={(p) => (
                      <TextField {...p} label="Nº de Autorización Disponible *" InputLabelProps={{ shrink: true }} />
                    )}
                  />
                </Grid>
                <Grid item xs={12} sm={6}>
                        ...
                        <TableCell align="center" padding="none" sx={{ px: 1 }}>
                          <TextField
                            ...
                            inputProps={{
                              style: {
                                textAlign: "center",
                                backgroundColor: formData.sripreauto === "E" ? "#e0e0e0" : "#fff",
                              },
                            }}
                            value={row.srisecfin}
