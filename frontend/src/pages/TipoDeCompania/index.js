                ...
                },
                {
                  ...
                  actions: [
                      ...
                      onClick: ({ columns, data }) => {
                        if (device === "sm") {
                          return handleExportDataPdfSMScreen(
                            columns,
                            data,
                            "Reporte de Tipos de Compañía",
                            `Reporte_TiposDeCompania_${new Date().toLocaleString()}`,
                          )
                        }
                        handleExportDataPdfLGScreen(
                          columns,
                    ...
                    },
                    {
                      ...
                      icon: getIconComponent(exportarAction?.accnameicono, exportarAction?.acctipoico),
                      onClick: ({ data }) => {
                        handleAllExportDataCSV(data, `Reporte_TiposDeCompania_${new Date().toLocaleString()}`)
                      },
                    },
                  ],
                },
