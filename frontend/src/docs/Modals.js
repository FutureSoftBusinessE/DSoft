  ...
  <Modal.Footer>
    ...
    <Button variant="primary" onClick={handleClose}>
      Save Changes
          ...
          <p>
            Another override is the option to pop up a modal that covers the user viewport. You can use the fullscreen
          ...
          <p>
            Modals have three optional sizes, available via size props to be placed on a <code>Modal</code>.
          </p>
