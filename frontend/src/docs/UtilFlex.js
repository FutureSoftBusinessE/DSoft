      ...
      <div className="main main-docs">
        <Container>
          ...
          <p className="main-title-text">
            ...
            full suite of responsive flexbox utilities.
          </p>
          ...
          <p>
            Apply display utilities to create a flexbox container and transform direct children elements into flex
            items.
          </p>
...
<div className="d-flex align-items-stretch ht-100 border">
  ...
  <div className="p-2 bg-gray-300 align-self-stretch">Flex item 4</div>
          ...
          <p>
            Use the <code>.flex-fill</code> class on a series of sibling elements to force them into widths equal to
            their content.
          </p>
  ...
  <div className="p-2 bg-gray-300 flex-fill">Flex item</div>
          ...
          <p>
            Use <code>.flex-grow</code> utilities to toggle a flex item's ability to grow to fill available space.
          </p>
...
<div className="d-flex">
  ...
  <div className="p-2 bg-gray-300">Flex item</div>
          ...
          <p>
            Looking to replicate the media object component from Bootstrap 4? Recreate it in no time with a few flex
            utilities that allow even more flexibility and customization than before.
          </p>
