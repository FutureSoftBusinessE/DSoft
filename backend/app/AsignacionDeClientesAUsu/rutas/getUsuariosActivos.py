...
@bp.route("/getUsuariosActivos", methods=["GET"])
@jwt_required()
def getAllUsuarios():
    claims = get_jwt()
    ...
    with engine.connect() as connection:
        with connection.begin():
            ...
            SELECT
                ...
                usrhormsys
            FROM siaccusr
            WHERE usrflagperfil != -1 and usrstatus = 'D'
            """
            # Si el usuario NO es gerente
            if not is_gerente_flag:
            ...
            empleados_result = [
                {
                    **row,
                    ...
                    "horarioEntrada": "8:00",  # TODO: Aun no manejo tabla de horarios por usuarios
                    "horarioSalida": "17:00",  # TODO: Aun no manejo tabla de horarios por usuarios
                }
                for row in result
            ]
