    ...
    <React.Fragment>
      ...
      <div className="main main-docs">
        <Container>
          ...
          <p>
            Margin utilities are the easiest way to add some structure to forms. They provide basic grouping of labels,
            controls, optional form text, and form validation messaging.
          </p>
...
<div>
  ...
  <Col>
    <Form.Control type="text" placeholder="Last name" aria-label="Last name" />
          ...
          <p>
            By adding gutter modifier classes, you can have control over the gutter width in as well the inline as block
            direction.
          </p>
  ...
  <Col>
    <Form.Control type="text" placeholder="Last name" aria-label="Last name" />
          ...
          <p>
            ...
            <code>Col</code> classes to specify the width of your labels and controls.{" "}
          </p>
          ...
          <Card className="card-example">
            <Card.Body>
              <Form>
                <Row className="mb-3">
                  <Form.Label htmlFor="inputEmail3" className="col-sm-2 col-form-label">
                    Email
                  </Form.Label>
                  <Col sm="10">
                ...
                <Row className="mb-3">
                  <Form.Label htmlFor="inputPassword3" className="col-sm-2 col-form-label">
                    Password
                  </Form.Label>
                  <Col sm="10">
  ...
  <Button type="submit" variant="primary">Sign in</Button>
          ...
          <p>
            As shown in the previous examples, our grid system allows you to place any number of <code>Col</code> within
            a <code>Row</code>. They'll split the available width equally between them.
          </p>
