...
class sap_IngresoInventario(db.Model):
    __tablename__ = "sap_IngresoInventario"
    ...
    num_material = db.Column(db.String(50), primary_key=True)
...
class sap_IngresoInventarioSchema(ma.Schema):
    class Meta:
        fields = (
            "id_men_legado",
            "num_pedido",
...
sap_IngresoInventario_schema = sap_IngresoInventarioSchema()
sap_IngresoInventario_schema_varios = sap_IngresoInventarioSchema(many=True)
