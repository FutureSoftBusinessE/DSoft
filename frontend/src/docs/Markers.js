      ...
      <div className="main main-docs">
        <Container>
          ...
          <p className="main-title-text">
            A marker is a type of label that can be attached in any images or cards component with the help of
...
<div className="marker bottom-right">Bottom Right Marker</div>`}</code>
          ...
          <p>
            A marker can be an icon with the use of class <code>.marker-icon.</code>
          </p>
...
<div className="marker-ribbon top-right">Top Right Marker</div>`}</code>
          ...
          <p>
            Add any of the below mentioned modifier classes to change the appearance of a marker. The example below uses
            border color utility class for card component and not part of the marker style.
          </p>
