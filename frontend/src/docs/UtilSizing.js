    ...
    <React.Fragment>
      ...
      <div className="main main-docs">
        <Container>
          ...
          <p>
            Use width utilities to quickly style the width of an element. Great for cards, buttons, or any other
            element.
          </p>
...
<div className="w-auto p-2 bg-secondary text-white text-center mt-2">auto width</div>`}</code>
          ...
          <p>
            Use height utilities to quickly style the height of an element. Great for cards, buttons, or any other
            element.
          </p>
          ...
          <Card className="card-example">
            <Card.Body>
              <Row className="g-1 px-1 border ht-250">
                <Col>
                  <div className="h-25 p-2 bg-secondary text-white text-center">25% height</div>
                </Col>
                <Col>
                  <div className="h-50 p-2 bg-secondary text-white text-center">50% height</div>
                </Col>
                <Col>
                  <div className="h-75 p-2 bg-secondary text-white text-center">75% height</div>
                </Col>
                <Col>
                  <div className="h-100 p-2 bg-secondary text-white text-center">100% height</div>
                </Col>
                <Col>
                  <div className="h-auto p-2 bg-secondary text-white text-center">auto height</div>
                </Col>
              </Row>
            </Card.Body>
            <Card.Footer>
