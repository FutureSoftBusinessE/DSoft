    ...
    <React.Fragment>
      ...
      <div className="main main-docs">
        <Container>
          ...
          <p>
            The accordion uses collapse internally to make it collapsible. Click the accordions below to expand/collapse
          ...
          <Card className="card-example">
            <Card.Body>
              <Alert variant="primary">
                A simple primary alert with <Alert.Link href="#">an example link</Alert.Link>. Give it a click if you
                like.
              </Alert>
...
<Alert variant="success">
  ...
  <p className="mb-0">
    ...
    nice and tidy.
          ...
          <p>
            Using the alert JavaScript plugin, it's possible to dismiss any alert inline. Add attribute{" "}
            <code>dismissible</code>, which adds extra padding to the right of the alert and positions the close button.
          </p>
  ...
  <strong>Holy guacamole!</strong> You should check in on some of those fields below.
          ...
          <p>
            An outline style variant with a little thicker border and a little thicker font weight with both border and
            text have the same color. Use one of the four required contextual classes.
          </p>
  ...
  This is a {variant} alert—check it out!
          ...
          <p>
            A solid background style variant with white text and without border. Use one of the four required contextual
            classes.
          </p>
  ...
  This is a {variant} alert—check it out!
          ...
          <p>
            Adding icon to different alert variant using additional class of <code>.d-flex</code> and{" "}
