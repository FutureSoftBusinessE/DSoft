...
<Spinner animation="grow" variant="dark" />`}</code>
          ...
          <p>
            Use flexbox utilities or text alignment utilities to place spinners exactly where you need them in any
            situation.
          </p>
  ...
  <Spinner animation="border" />
          ...
          <p>
            Add <code>.spinner-border-sm</code> and <code>.spinner-grow-sm</code> to make a smaller spinner that can
