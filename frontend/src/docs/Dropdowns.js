      ...
      <div className="main main-docs">
        <Container>
          ...
          <p className="main-title-text">
            ...
            interactive with the included Bootstrap dropdown javascript plugin.
          </p>
          ...
          <p>
            Wrap the dropdown's toggle (your button or link) and the dropdown menu within .dropdown, or another element
            that declares position relative. Dropdowns can be triggered from link or button elements to better fit your
            potential needs.
          </p>
  ...
  <Dropdown.Menu>
    ...
    <Dropdown.Item href="#/action-3">Something else</Dropdown.Item>
          ...
          <Card className="card-example">
            <Card.Body>
              <Dropdown drop="up">
                <Dropdown.Toggle variant="secondary">Dropup Button</Dropdown.Toggle>
          ...
          <Card className="card-example">
            <Card.Body>
              <Dropdown drop="end">
                <Dropdown.Toggle variant="secondary">Dropright Button</Dropdown.Toggle>
          ...
          <Card className="card-example">
            <Card.Body>
              <Dropdown drop="start">
                <Dropdown.Toggle variant="secondary">Dropleft Button</Dropdown.Toggle>
