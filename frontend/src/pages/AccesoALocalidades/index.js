      ...
      <div className="main main-app p-3 p-lg-4">
        ...
        <Box className={StyledRoot}>
          <CustomConditionalActionsTableServer
            ...
            endpoint="/AccesoALocalidades/getAllUsuarios"
            errorMsgFilterSearch="Error en cargar datos"
            queryKeyModal="getAllUsersModulosAccesoALocalidades"
            perPage={10}
            ...
            columnsTable={[
              ...
              },
              {
                ...
                header: "Estado",
                size: 120,
                Cell: ({ cell }) => <span>{cell.getValue() === "A" ? "Activo" : "No Activo"}</span>,
              },
            ]}
          />
        </Box>
...
export default AccesoALocalidades
