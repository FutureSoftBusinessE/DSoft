...
export default function LayoutGutters() {
  ...
  <Col><span>3 of 3 Column</span></Col>
          ...
          <p>
            Like the horizontal gutters, the vertical gutters can cause some overflow below the row at the end of a
            page.
          </p>
  ...
  <Col xs="6"><span>4 of 4 Column</span></Col>
          ...
          <p>
            Classes <code>.g-*</code> can be used to control the horizontal gutter widths, for the following example we
            use a smaller gutter width, so there won’t be a need to add the .overflow-hidden wrapper class.
          </p>
  ...
  <Col xs="6"><span>4 of 4 Column</span></Col>
          ...
          <p>
            The gutters between columns in our predefined grid classes can be removed with <code>.g-0</code>. This
