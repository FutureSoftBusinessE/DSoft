...
const CrearTransportistaDF = () => {
  ...
  const validarIdentificacionTransportista = (tipoTrans, numero) => {
    ...
    if (tercerDigito < 6) {
      ...
      for (let i = 0; i < 9; i++) {
        const v = digitos[i] * coeficientes[i]
        suma += v > 9 ? v - 9 : v
      }
      const verificador = suma % 10 === 0 ? 0 : 10 - (suma % 10)
      if (verificador !== digitos[9])
        return { ok: false, msg: "Número de identificación incorrecto (Dígito verificador fallido)" }
      return { ok: true }
    }
  ...
  const handleInputChange = (field, value, isEmail = false) => {
    const val = typeof value === "string" && !isEmail ? value.toUpperCase() : value
          ...
          <Paper elevation={3} sx={{ p: 4 }}>
            ...
            <Grid container spacing={3}>
              <Grid item xs={12} sm={3}>
                <TextField
                  fullWidth
                  label="Código *"
                  value={formData.transcodigo}
                  onChange={(e) => handleInputChange("transcodigo", e.target.value)}
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={(e) => handleInputChange("transtipo", e.target.value)}
                >
              ...
              <Grid item xs={12} sm={3}>
                <TextField
                  ...
                  onChange={(e) => handleInputChange("transstatus", e.target.value)}
                >
              ...
              <Grid item xs={12}>
                <TextField
                  fullWidth
                  label="Nombre *"
                  value={formData.transdescri}
                  onChange={(e) => handleInputChange("transdescri", e.target.value)}
                />
              </Grid>
              <Grid item xs={12}>
                <TextField
                  fullWidth
                  label="Dirección *"
                  value={formData.transdirec}
                  onChange={(e) => handleInputChange("transdirec", e.target.value)}
                />
              </Grid>
              <Grid item xs={12} sm={4}>
                <TextField
                  fullWidth
                  label="Teléfono"
                  value={formData.transtelef1}
                  onChange={(e) => handleInputChange("transtelef1", e.target.value)}
                />
              </Grid>
              <Grid item xs={12} sm={4}>
                <TextField
                  fullWidth
                  label="Cédula/R.U.C. *"
                  value={formData.transruc}
                  onChange={(e) => handleInputChange("transruc", e.target.value)}
                />
              </Grid>
              <Grid item xs={12} sm={4}>
                <TextField
                  ...
                  onChange={(e) => handleInputChange("transcuenta", e.target.value)}
                />
              </Grid>
            </Grid>
            ...
            <Grid container spacing={3}>
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  value={formData.transcontactonombre}
                  onChange={(e) => handleInputChange("transcontactonombre", e.target.value)}
                />
              </Grid>
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  value={formData.transcontactodirec}
                  onChange={(e) => handleInputChange("transcontactodirec", e.target.value)}
                />
              </Grid>
              <Grid item xs={12} sm={6}>
                <TextField
                  fullWidth
                  label="Email"
                  value={formData.transcontactoemail}
                  onChange={(e) => handleInputChange("transcontactoemail", e.target.value, true)}
                />
              </Grid>
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  value={formData.transcontactotelef}
                  onChange={(e) => handleInputChange("transcontactotelef", e.target.value)}
                />
              </Grid>
            </Grid>
            <Divider sx={{ my: 4 }} />
            <Grid container spacing={3} justifyContent="center">
              <Grid item xs={12} sm={6}>
                <TextField
                  fullWidth
                  label="Placa Sugerida (Guía Remisión)"
                  value={formData.transplaca}
                  onChange={(e) => handleInputChange("transplaca", e.target.value)}
                />
              </Grid>
            </Grid>
          </Paper>
