...
const FacturaDesdeArticulosDF = () => {
  ...
  const handleFacturar = async (row) => {
    try {
      ...
      const responseFacturar = await api.post("/FacturaDesdeArticulosDF/facturarProforma", {
  ...
  const handleAutorizar = async (row) => {
    try {
      ...
      const responseRecuperar = await api.post("/FacturaDesdeArticulosDF/recuperarPayloadFactura", {
      ...
      <div className="main main-app p-3 p-lg-4">
        ...
        <Box className={StyledRoot}>
          <CustomConditionalActionsTableServer
            endpoint="/FacturaDesdeArticulosDF/getAllFacturas"
                ...
                actions.push({
                  ...
                  onClick: async (row) => {
                    ...
                    if (result.isConfirmed) {
                      try {
                        await api.post("/FacturaDesdeArticulosDF/deleteFactura", {
                          ciacodigo: row.original.ciacodigo,
                          pednumped: row.original.pednumped,
                          loccodigo: row.original.loccodigo,
                        })
...
export default FacturaDesdeArticulosDF
