...
from app.CargaDeTrabajo import bp
    ...
    with engine.connect() as connection:
        with connection.begin():
            ...
            if usrcodigo_external:
                ...
                where_clauses_external.append("[Codigo Usuario] = :usrcodigo_ext")
                ...
                if not is_gerente_flag:
                    where_clauses_external.append("[Codigo Usuario] IN :usuarios_permitidos_ext")
            ...
            # Construir consulta base (SIN ciacodigo)
            base_query = """
            SELECT
                [Codigo Usuario],
                [Nombre Usuario],
            ...
            # Orden por defecto
            order_by = ["[Horas Totales Pendientes] DESC", "[Nombre Usuario] ASC"]
