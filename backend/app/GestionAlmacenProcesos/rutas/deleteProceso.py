...
@jwt_required()
def deleteGestionAlmacenProcesos(procesocod):
    ...
    try:
        ...
        db.session.query(siacprocesos).filter(siacprocesos.ciacodigo == ciacodigo, siacprocesos.procesocod == procesocod).delete()
