    ...
    with engine.connect() as connection:
        with connection.begin():
            ...
            allowed_columns = [
                ...
                {"usrflagperfil": FILTER_VALUE_TYPE.NUMBER},
                {"usrfecmsys": FILTER_VALUE_TYPE.DATETIME},
                {"usrhormsys": FILTER_VALUE_TYPE.DATETIME},
            ]
            ...
            SELECT DISTINCT
                ...
                scu.usrhormsys
            FROM siaccusr scu
            INNER JOIN siactusr sct
                ON sct.usrcodigo = scu.usrcodigo
            INNER JOIN siaccia sca
                ON sca.ciacodigo = sct.ciacodigo
            WHERE scu.usrflagperfil = 0
            """
