...
export default function OffCanvas() {
      ...
      <div className="main main-docs">
        <Container>
          ...
          <p>
            ...
            padding. We suggest that you include offcanvas headers with dismiss actions whenever possible, or provide an
  ...
  <Offcanvas.Body>
    ...
    have chosen. Like, text, images, lists, etc.
          ...
          <p>
            Scrolling the body element is disabled when an offcanvas and its backdrop are visible. Use the scroll prop
            to toggle body scrolling and the backdrop prop to toggle the backdrop.
          </p>
