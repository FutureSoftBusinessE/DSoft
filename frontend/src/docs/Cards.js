...
<Card className="card-dark">...</Card>`}</code>
          ...
          <p>
            ...
            groups use flex display to achieve their uniform sizing.
          </p>
  ...
  <Card>...</Card>
          ...
          <p>
            Use the Bootstrap grid system and its <code>.row-cols</code> classes to control how many grid columns
            (wrapped around your cards) you show per row. For example, here's <code>.row-cols-1</code> laying out the
            cards on one column, and <code>.row-cols-md-2</code> splitting four cards to equal width across multiple
