...
import { 
  ...
  Divider, Radio, RadioGroup, FormControlLabel, FormControl, FormLabel 
} from "@mui/material"
      ...
      <div className="main main-app p-3 p-lg-4">
        ...
        <Box sx={StyledRoot} component="form" onSubmit={handleSubmit}>
          <Paper elevation={3} sx={{ p: 4, borderRadius: 3, border: "1px solid #ccc" }}>
            ...
            <Typography variant="h6" color="primary" sx={{ mb: 1 }}>Datos Generales</Typography>
            <Divider sx={{ mb: 3 }} />
              ...
              <Grid container spacing={2} alignItems="center">
                <Grid item xs={12} sm={8}>
                  <FormControl component="fieldset">
                    <FormLabel component="legend" sx={{ fontWeight: 'bold', color: 'primary.main', mb: 1 }}>Tipo de Autorización</FormLabel>
                    <RadioGroup 
                      row 
                      name="sripreauto" 
            ...
            <Box sx={{ border: "1px solid #ddd", borderRadius: 1, p: 2, mb: 3 }}>
              <FormControl component="fieldset" fullWidth>
                <FormLabel component="legend" sx={{ fontWeight: 'bold', color: 'primary.main', mb: 1 }}>Tipo de Trámite</FormLabel>
                <RadioGroup 
                  name="sritramite" 
                ...
                >
                  ...
                  <FormControlLabel value={7} control={<Radio color="primary" />} label="7 Solicitud de autorización por cambio de Software" />
                  <FormControlLabel value={8} control={<Radio color="primary" />} label="8 Renovación de la autorización" />
