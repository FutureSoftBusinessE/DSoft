...
def get_info_ruc_sri(ruc):
    try:
        ...
        if len(ruc_clean) != 13:
            raise ValidationError(f"El RUC debe tener 13 dígitos.")
        ...
        if response.status_code == 200:
            ...
            if sri_data_list and len(sri_data_list) > 0:
                ...
                if not isinstance(fechas_raw, dict): fechas_raw = {}
                ...
                formatted_data = {
                    ...
                    "actividadEconomicaPrincipal": (
                        sri_data.get("actividadEconomicaPrincipal") or 
                        sri_data.get("actividadEconomicaPpal") or 
                        sri_data.get("actividadPrincipal") or 
                        sri_data.get("descripcionActividad") or ""
                    ).upper(),
                ...
                try:
                    ...
                    with engine.connect() as conn:
                        ...
                        if res: formatted_data["local_codigo"] = res[0]
                except: formatted_data["ya_registrado"] = False
